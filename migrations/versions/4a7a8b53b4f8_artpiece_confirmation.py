...
def upgrade():
    ...
    op.execute(("INSERT INTO "
        "new_artpieces("
        "title, submit_date, art_encoding, submission_status, raw_image, user_id, confirmed) "
        "SELECT artpieces.title, artpieces.submit_date, artpieces.art_encoding, artpieces.submission_status, artpieces.raw_image, artpieces.user_id, True as confirmed "
        "FROM artpieces ")
    )
